...
NDiplomacy = {
	...
	TENSION_JOIN_ATTACKER = 4,						-- scale of the amount of tension added when country joins attacker side
...
NMilitary = {
	...
	BASE_LEADER_TRAIT_GAIN_XP = 0.3,				   -- Base xp gain for traits per hour.
...
NFocus = {
	FOCUS_POINT_DAYS = 4,						-- Each point takes 4 days
	FOCUS_PROGRESS_PEACE = 1,					-- Progress during peace
	FOCUS_PROGRESS_WAR = 1,					-- Progress during war
	MAX_SAVED_FOCUS_PROGRESS = 60,				-- This much progress can be saved while not having a focus selected. in this case for 60 days.
	},
}
